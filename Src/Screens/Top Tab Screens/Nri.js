...
import { BaseUrl, CategoryUrl, National, Nri, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class NriNews extends Component {
    constructor(props) {
        super(props);
        this.state = {
            HyderabadData: [],
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"ఎన్‌ఆర్‌ఐ"} isMenu={false} isBook={false} isShare={true}
