...
import { BaseUrl, CategoryUrl, Kathalu, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class KathaluNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Kathalu
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"కథలు"} isMenu={false} isBook={false} isShare={true}
