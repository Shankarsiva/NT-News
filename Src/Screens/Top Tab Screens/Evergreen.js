...
import { BaseUrl, CategoryUrl, Evergreen, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class EvergreenNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Evergreen
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"ఎవర్‌గ్రీన్‌"} isMenu={false} isBook={false} isShare={true}
