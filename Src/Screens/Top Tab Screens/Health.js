...
import { BaseUrl, CategoryUrl, Health, National, ShareUrl } from "../../Utilities/Api/Urls";
...
export default class HealthNews extends Component {
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Health
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"ఆరోగ్యం"} isMenu={false} isBook={false} isShare={true}
