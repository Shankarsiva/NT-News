...
import { BaseUrl, Business, CategoryUrl, National, ShareUrl } from "../../Utilities/Api/Urls";
...
export default class BusinessNews extends Component {
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Business
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"బిజినెస్"} isMenu={false} isBook={false} isShare={true}
