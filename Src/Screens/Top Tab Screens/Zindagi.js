...
import { BaseUrl, CategoryUrl, National, ShareUrl, Zindagi } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class ZindagiNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Zindagi
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"జిందగీ"} isMenu={false} isBook={false} isShare={true}
