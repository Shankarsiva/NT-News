...
import { BaseUrl, CategoryUrl, National, ShareUrl, Telangana } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class TelanganaNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Telangana
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"తెలంగాణ"} isMenu={false} isBook={false} isShare={true}
