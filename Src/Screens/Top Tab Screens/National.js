...
import { BaseUrl, CategoryUrl, National, ShareUrl } from "../../Utilities/Api/Urls";
...
export default class NationalNews extends Component {
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + National
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"జాతీయం"} isMenu={false} isBook={false} isShare={true}
