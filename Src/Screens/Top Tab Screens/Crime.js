...
import { BaseUrl, CategoryUrl, Crime, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class CrimeNews extends Component {
    constructor(props) {
        super(props);
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"క్రైమ్‌"} isMenu={false} isBook={false} isShare={true}
