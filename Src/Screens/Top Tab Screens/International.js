...
import { BaseUrl, CategoryUrl, International, National, ShareUrl } from "../../Utilities/Api/Urls";
...
export default class InternationalNews extends Component {
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + International
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"అంతర్జాతీయం"} isMenu={false} isBook={false} isShare={true}
