...
import { Agriculture, BaseUrl, CategoryUrl, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class AgricultureNews extends Component {
    constructor(props) {
        super(props);
        this.state = {
            HyderabadData: [],
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Agriculture
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"వ్యవసాయం"} isMenu={false} isBook={false} isShare={true}
