...
import { Ap, BaseUrl, CategoryUrl, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class ApNews extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <SafeAreaView styles={commonstyles.container}>
                ...
                <SubHeader title={"ఏపీ"} isMenu={false} isBook={false} isShare={true}
