...
import { BaseUrl, CategoryUrl, Editpage, National, ShareUrl } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class EditpageNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Editpage
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"ఎడిట్‌ పేజీ"} isMenu={false} isBook={false} isShare={true}
