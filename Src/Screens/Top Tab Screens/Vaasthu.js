...
import { BaseUrl, CategoryUrl, National, ShareUrl, Vaasthu } from "../../Utilities/Api/Urls";
import moment from 'moment'
import FastImage from 'react-native-fast-image'

export default class VaasthuNews extends Component {
    constructor(props) {
        super(props);
    ...
    // share function
    sharecall = () => {
        const Link_Url = ShareUrl + Vaasthu
        Share.share({
            message: Link_Url
        })
 ...
 isMenu={true} isNotif={true}
                ...
                <SubHeader title={"వాస్తు"} isMenu={false} isBook={false} isShare={true}
